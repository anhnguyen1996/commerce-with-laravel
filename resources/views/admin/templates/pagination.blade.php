...
<ul class="pagination d-flex justify-content-center">
    ...
    @if ($afterPage1Level <= $totalPages)
      <li class="page-item"><a class="page-link" href="{{url($url . $afterPage1Level)}}">{{$afterPage1Level}}</a></li>
    @endif
    @if ($afterPage2Level <= $totalPages)
      <li class="page-item"><a class="page-link" href="{{url($url . $afterPage2Level)}}">{{$afterPage2Level}}</a></li>
    @endif
    @if ($currentPage + 1 <= $totalPages)
      <li class="page-item"><a class="page-link" href="{{url($url . $afterPage1Level)}}">Tiếp tục</a></li>
    @endif
</ul>
@endisset
<!-- End pagination -->